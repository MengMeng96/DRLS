...
def test(actor_agent):
    ...
    print(args.data_path, actor_agent.env.tt_query_id, edge_usage)
...
def main():
    ...
    # 加载已经训练好的模型，参数是模型位置
    actor_agent.saver_policy.restore(actor_agent.sess, "../models/092403/policy/")
    datasets = ['../resource/data/3_64_128/', '../resource/data/3_128_256/', '../resource/data/3_256_512/', '../resource/data/3_512_1024/'
        , '../resource/data/3_512_1024_2/', '../resource/data/3_512_1024_3/', '../resource/data/3_1024_2048/', '../resource/data/3_1024_2048_2/'
        , '../resource/data/3_1024_2048_3/', '../resource/data/3_2048_4096/', '../resource/data/3_2048_4096_2/', '../resource/data/3_2048_4096_3/']
